...
import { IDisplayDensityOptions, DisplayDensityBase, DisplayDensity } from '../core/density';
...
export declare class IgxPaginatorComponent extends DisplayDensityBase {
    ...
    private get classCosy();
    private get classCompact();
    private get classComfortable();
    /**
