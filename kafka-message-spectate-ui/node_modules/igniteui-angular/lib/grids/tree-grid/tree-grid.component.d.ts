import { OnInit, TemplateRef, AfterContentInit, DoCheck, AfterViewInit, ElementRef, NgZone, ChangeDetectorRef, IterableDiffers, ViewContainerRef, ApplicationRef, Injector, EnvironmentInjector } from '@angular/core';
