...
export declare abstract class IgxTabItemDirective implements IgxTabItemBase, IgxSlideComponentBase {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<IgxTabItemDirective, never, never, { "disabled": { "alias": "disabled"; "required": false; }; "selected": { "alias": "selected"; "required": false; }; }, { "selectedChange": "selectedChange"; }, ["headerComponent", "panelComponent"], never, false, never>;
}
